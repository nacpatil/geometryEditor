...
if __name__ == "__main__":
    # Add scatter points
    square = PolygonSurface(
        x=[0, 2, 2, 0],
        y=[0, 0, 2, 2],
        z=[0, 0, 0, 0],  # Flat on XY plane
        title="Square"
    )

    # Rotate the polygon 30° around its center
    square.rotate(axis='z', degrees=30)

    # Move the polygon 3 units along X-axis
    square.translate(dx=0, dy=0, dz=0)
